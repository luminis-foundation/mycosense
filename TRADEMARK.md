...
You may accurately state that your work is **based on** or **derived from**
...
- Register trademarks or domain names that are confusingly similar to the
  protected marks

## Fair Use

Nominative fair use — referring to MycoSense by name for purposes of
identification, comparison, commentary, or interoperability — is permitted
provided it does not create confusion about the source or sponsorship of your
product or service.
